...
export const CARD_SPECS: CardSpec[] = [
  ...
  { name: 'Role Audit', copies: 2, deckType: 'Employee', effectType: 'peek_and_swap', effectParams: {}, requiresTarget: true, flavour: 'Your job title has been updated. Your job has not.' },
  ...
  // ---- Support Deck (3) ----
  // Design note (spec §6): three support cards in a 110-card game about
